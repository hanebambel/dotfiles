...
# ============================================================
# Edit these values to customize your install. All values have
# sensible defaults -- only change what you need.
#
# This file is sourced by the bootstrap and update scripts via
# lib/common.sh's load_config function.
#
